...
namespace ClashResources
{
    public static class CardLinks
    {
        public static List<Tuple<string, string, string>> getCardLinks()
        {
            ...
            tmpList.Add(new Tuple<string, string, string>("guards", "https://www.youtube.com/watch?v=PZvaq0CCRk8&list=PLz3utPLAut6GKZADTdg3zK6lh20D0KB6Z&index=7", "How To Use/Counter"));
